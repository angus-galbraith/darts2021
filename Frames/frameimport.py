...
class scoreFrame(Frame):
    ...
    def screen_setup(self, player1, player2):
        ...
        self.pl1_remaining = Label(self, text=self.player1["score"], font=(None, 40))
        self.pl1_remaining.grid(row=1, column=0)
        self.pl1_remaining.configure(bg="white")
        self.pl2_remaining = Label(self, text=self.player2["score"], font=(None, 40))
